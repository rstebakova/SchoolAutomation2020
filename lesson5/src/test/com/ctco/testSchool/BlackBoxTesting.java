...
public class BlackBoxTesting {
  ...
  /* - Negative case: team can not deliver stories. with two tester in team and 1 devs work if sprint is short;*/
    ...
    @Test
    public void negativeCanDeliverQualityWithZeroVelocityForQA() {
        // add sprint days
        myTeam.sprintDays = 5;

        // add qa member with velocity 0
        myTeam.addMember(first_qa);
    ...
    @Test
    public void negativeCanDeliverQualityWithZeroVelocityForDEV() {
        ...
        // add first_dev member with velocity 0
        myTeam.addMember(first_dev);
        ...
        //verify that scope can't be delivered
        Assert.assertThat("Can't be delivered if first_dev's velocity is null", myTeam.canDeliverQuality(), is(false));
    }
